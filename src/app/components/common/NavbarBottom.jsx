...
export default function NavbarBottom() {
  ...
  // Quadruple features so marquee loops seamlessly across phone and tablet screens
  ...
  return (
    ...
    >
      <div className="w-full px-4 py-2 sm:py-1.5">
        ...
        {/* Mobile & Tablet - Scrolling Marquee with edge gradient fades */}
        <div className="lg:hidden overflow-hidden relative w-full">
          <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-r from-[var(--nav-start)] to-transparent z-10" />
          <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-[var(--nav-end)] to-transparent z-10" />
